...
#[derive(Debug)]
pub struct DriverJoltProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DriverJoltProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DriverJolt processing");
    
    let mut processor = DriverJoltProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DriverJoltProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DriverJoltProcessor::new(false);
